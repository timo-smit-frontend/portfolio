const EXPERIENCES = [
  ...
  {
    image: '/assets/logo/tweede-kamer.jpg',
  ...
  {
    image: '/assets/logo/wfp.webp',
    title: 'Project Enhance',
    description:
      'As part of my time at Capgemini, I contributed to Project Enhance in collaboration with the United Nations World Food Programme. This innovative initiative aims to model and calculate dietary patterns tailored to individual needs and local contexts, with a focus on improving nutrition, affordability, and sustainability. My role centered on optimizing the project’s digital platform—enhancing performance, streamlining the user experience, and improving overall usability. Being part of such a globally impactful project allowed me to apply both my design and development skills in a meaningful, real-world context.'
  },
  {
    image: '/assets/logo/accent-interactive.jpeg',
  ...
  {
    image: '/assets/logo/smart-hotel.jpg',
    title: 'SmartHOTEL',
    description:
